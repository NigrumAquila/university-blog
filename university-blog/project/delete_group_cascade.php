...
if ((isset($_POST['group'])) && ($_POST['group'] != "")) {
  $deletestudentsSQL = sprintf("DELETE FROM students WHERE group_name = %s",
  ...
  $Result1 = mysqli_query($studies_date, $deletestudentsSQL) or die($studies_date->error);
  $Result1 = mysqli_query($studies_date, $deleteSQL) or die($studies_date->error);
  $R = mysqli_query($studies_date, "UNLOCK TABLES") or die($studies_date->error);
