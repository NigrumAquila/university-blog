...
mysqli_select_db($studies_date, $database_studies_date);
$query_student = sprintf("SELECT stud_id, groups.group_name, surname, name, patronymic, groups.group_id
FROM students, groups   
WHERE students.group_name = groups.group_id AND stud_id=%s", $colname_student);
...
<p>
 <input name="student" type="hidden" id="student" value="<?php echo $row_student['stud_id']; ?>">
  ...
  <p><a href="students?group=<?php echo $row_student['group_id']; ?>">На список студентов группы <?php echo $row_student['group_name']; ?></a> </p>
